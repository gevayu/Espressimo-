      ...
      <div className="flex overflow-x-auto">
        {posts.map((post, i) => (
          <div key={i} className="shrink-0 w-[20%] min-w-[280px] border-l border-[#e6dad4] p-6 first:border-l-0">
            ...
            <p className="text-[#522c25] text-[10px] tracking-[0.6px] uppercase font-['Dialect_PM',sans-serif] opacity-60 mb-2">
              {post.date}
            </p>
            <h3 className="text-[#522c25] text-[19.2px] leading-[20px] font-['Dialect_PM',sans-serif] mb-3">
              {post.title}
            </h3>
            <a href="#" className="text-[#522c25] text-[10px] tracking-[0.6px] uppercase font-['Dialect_PM',sans-serif] underline">
              {post.action}
            </a>
          </div>
        ))}
