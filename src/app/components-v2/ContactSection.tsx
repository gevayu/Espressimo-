      ...
      <div className="flex items-stretch">
        ...
        <div className="flex-1 p-14 flex flex-col justify-center border-l border-[#e6dad4]">
          <h2 className="text-[#522c25] text-[53px] leading-[41px] font-['Dialect_PM',sans-serif] font-bold tracking-[0.05em] font-bold mb-4">
            קפה מושלם, מתחיל כאן –{" "}
            <span className="text-[#8B3A00]">דברו עם המומחה!</span>
          </h2>
          ...
          <form className="flex flex-col gap-4">
            <div className="flex gap-4">
              <div className="flex-1 flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="bg-[#f6ede3] border border-[#e6dad4] rounded px-4 py-3 text-[#522c25] text-[32px] font-['Dialect_PM',sans-serif] outline-none focus:border-[#8B3A00] transition-colors"
                />
              </div>
              <div className="flex-1 flex flex-col gap-1.5">
                <label className="text-[#522c25] text-[23px] tracking-[0.6px] uppercase font-['Dialect_PM',sans-serif] opacity-70">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="bg-[#f6ede3] border border-[#e6dad4] rounded px-4 py-3 text-[#522c25] text-[32px] font-['Dialect_PM',sans-serif] outline-none focus:border-[#8B3A00] transition-colors resize-none"
              />
            </div>
            <button
              type="submit"
              className="bg-[#8B3A00] text-white px-7 py-3 rounded text-[30px] tracking-[0.07em] uppercase font-['Dialect_PM',sans-serif] w-fit mt-2 hover:bg-[#a32801] transition-colors"
            >
              שלחו הודעה
            </button>
          </form>
