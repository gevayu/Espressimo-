      ...
      <div className="flex items-center h-[68px]">
        ...
        <div className="flex-1 flex items-center border-l border-[#e6dad4] h-full px-4">
          <div className="flex items-center w-full">
            <span className="text-[#522c25] text-[12.9px] tracking-[0.7px] uppercase font-['Dialect_PM',sans-serif] opacity-60">חיפוש</span>
          </div>
        </div>

        {/* Account & Cart */}
        <div className="flex items-center border-l border-[#e6dad4] h-full px-6 gap-6">
          <button className="flex items-center gap-1.5 text-[#522c25] text-[12px] tracking-[0.7px] uppercase font-['Dialect_PM',sans-serif]">
            חשבון <ChevronDown size={10} />
          </button>
          <a href="#" className="flex items-center gap-1.5 text-[#522c25] text-[13px] tracking-[0.7px] uppercase font-['Dialect_PM',sans-serif]">
